...
import { Plus, Edit3, Trash2, Save, X, CheckCircle2, Search } from 'lucide-react';
...
const EMPTY       = { name:'', yearGroup:'Form 1', course:'General Science', capacity:40, formTeacher:'', enrolled:0 };
            ...
            <div key={cls.id} className="bg-white rounded-2xl border shadow-sm p-4"
              ...
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="flex gap-1.5">
                  <button type="button"
                    onClick={()=>{ setEditC(cls); setForm({...cls}); setShowForm(true); }}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="p-5 space-y-4">
              ...
              <FInput label="Year Group"   field="yearGroup"   options={YEAR_GROUPS}/>
