      ...
      >
        ...
        {!collapsed && (
          <div className="flex flex-col items-center py-4 px-4 border-b border-white/20 flex-shrink-0">
            ...
            <p className="text-blue-200 text-xs text-center mt-0.5 font-mono">
              {user?.studentId}
            </p>
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-3">
          ...
          {!collapsed && (
            <p
              className="text-xs font-black px-3 pt-2 pb-1 uppercase tracking-widest"
