...
export const ACADEMIC_YEARS = [
  {
    ...
    year: "2024/2025",
    status: "active",
    sem1: { start: "2024-09-02", end: "2024-12-13" },
    sem2: { start: "2025-01-06", end: "2025-04-11" },
  ...
  },
  {
    ...
    year: "2023/2024",
    status: "archived",
    sem1: { start: "2023-09-04", end: "2023-12-15" },
    sem2: { start: "2024-01-08", end: "2024-04-12" },
  ...
  },
  {
    ...
    year: "2022/2023",
    status: "archived",
    sem1: { start: "2022-09-05", end: "2022-12-16" },
    sem2: { start: "2023-01-09", end: "2023-04-14" },
    notes:
      "Completed. First year with full transitional system implementation.",
  },
];
...
export const STUDENTS = [
  // ── FORM 1 ────────────────────────────────────────────────────────────────
  {
    ...
    avgScore: 84,
    parentId: 1,
    enrollDate: "2024-09-02",
    email: "kwabena.acheampong@afts.edu.gh",
    password: "student123",
    address: "Uaddara Barracks, Kumasi",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 2,
    enrollDate: "2024-09-02",
    email: "adwoa.mensah@afts.edu.gh",
    password: "student123",
    address: "Asokwa, Kumasi",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 3,
    enrollDate: "2024-09-02",
    email: "kofi.boateng@afts.edu.gh",
    password: "student123",
    address: "Bantama, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 7,
    enrollDate: "2024-09-02",
    email: "nana.frimpong@afts.edu.gh",
    password: "student123",
    address: "Suame, Kumasi",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 8,
    enrollDate: "2024-09-02",
    email: "akosua.tawiah@afts.edu.gh",
    password: "student123",
    address: "Dichemso, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 12,
    enrollDate: "2024-09-02",
    email: "fiifi.sarpong@afts.edu.gh",
    password: "student123",
    address: "Manhyia, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 1,
    enrollDate: "2024-09-02",
    email: "abena.asante@afts.edu.gh",
    password: "student123",
    address: "Uaddara Barracks, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 17,
    enrollDate: "2023-09-04",
    email: "akua.acheampong@afts.edu.gh",
    password: "student123",
    address: "Bantama, Kumasi",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 18,
    enrollDate: "2023-09-04",
    email: "nanayaw.mensah@afts.edu.gh",
    password: "student123",
    address: "Oforikrom, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 20,
    enrollDate: "2023-09-04",
    email: "kwabena.frimpong@afts.edu.gh",
    password: "student123",
    address: "Suame, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 24,
    enrollDate: "2023-09-04",
    email: "fiifi2.sarpong@afts.edu.gh",
    password: "student123",
    address: "Manhyia, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 28,
    enrollDate: "2023-09-04",
    email: "akosua.agyemang@afts.edu.gh",
    password: "student123",
    address: "Kwadaso, Kumasi",
    redirectTo: "/student",
  },
  ...
  // ── FORM 3 ────────────────────────────────────────────────────────────────
  {
    ...
    avgScore: 88,
    parentId: 29,
    enrollDate: "2022-09-05",
    email: "abena.frimpong@afts.edu.gh",
    password: "student123",
    address: "Asokwa, Kumasi",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 30,
    enrollDate: "2022-09-05",
    email: "kwabena.agyei@afts.edu.gh",
    password: "student123",
    address: "Bantama, Kumasi",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 31,
    enrollDate: "2022-09-05",
    email: "maameesi.darko@afts.edu.gh",
    password: "student123",
    address: "Nhyiaeso, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 38,
    enrollDate: "2022-09-05",
    email: "nanakwame.bonsu@afts.edu.gh",
    password: "student123",
    address: "Kumasi Central",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 39,
    enrollDate: "2022-09-05",
    email: "afia.sarpong@afts.edu.gh",
    password: "student123",
    address: "Manhyia, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 41,
    enrollDate: "2022-09-05",
    email: "esi.frimpong@afts.edu.gh",
    password: "student123",
    address: "Asokwa, Kumasi",
    redirectTo: "/student",
  },
  ...
  },
  {
    ...
    parentId: 43,
    enrollDate: "2022-09-05",
    email: "adwoa.asante@afts.edu.gh",
    password: "student123",
    address: "Uaddara Barracks, Kumasi",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 44,
    enrollDate: "2022-09-05",
    email: "fiifi3.mensah@afts.edu.gh",
    password: "student123",
    address: "Patasi, Kumasi",
    redirectTo: "/student",
  },
  {
    ...
    parentId: 45,
    enrollDate: "2022-09-05",
    email: "yaa.acheampong@afts.edu.gh",
    password: "student123",
    address: "Suame, Kumasi",
    redirectTo: "/student",
  },
...
export const PARENTS = [
  ...
  },
  {
    ...
    firstName: "Comfort",
    lastName: "Tawiah",
    email: "comfort.tawiah@gmail.com",
    phone: "0277789012",
    occupation: "Banker",
    address: "Dichemso, Kumasi",
    status: "Active",
  ...
  },
  {
    ...
    firstName: "Adwoa",
    lastName: "Asante",
    email: "adwoa.asante@outlook.com",
    phone: "0277901234",
    occupation: "Doctor",
    address: "Uaddara Barracks, Kumasi",
    status: "Active",
...
// Student: kofi@afts.edu.gh         / student123  (ID: AFSHTS/2024/001)
